    ...
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          CommonText(title: loginWatch.mode == true ? "Sign in to your personal dashboard" : "Sign in with your own credentials" ,
              style: TextStyles.regular.copyWith(fontSize: 12.sp,color: AppColors.black838383)),
          ...
          Row(
            children: [
              Expanded(child: CommonButton(
                ...
                isGradient: false,
                isPrefixEnable: true,
                leftImage: Assets.svgs.svgGoogle.path,
                leftImageHeight: 20.h,
              )),
              SizedBox(width: 10.h,),
              Expanded(child: CommonButton(
                height: 30.h,
                ...
                borderRadius: BorderRadius.circular(14.r),
                isPrefixEnable: true,
                leftImage: Assets.svgs.svgApple.path,
                leftImageHeight: 20.h,
              )),
            ],
          ),
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  ...
                  child: CommonText(
                    title: "Create one free",
                    style: TextStyles.regular.copyWith(color: AppColors.secondary,fontSize: 14.sp),
                  )
              ),
            ],
          ),
