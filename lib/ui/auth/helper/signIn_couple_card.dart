...
class SigninCoupleCard extends ConsumerStatefulWidget {
  const SigninCoupleCard({super.key});

  @override
  ConsumerState createState() => _SigninCoupleCardState();
}

class _SigninCoupleCardState extends ConsumerState<SigninCoupleCard> {
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        // crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CommonText(title: "Couple Sign In",style: TextStyles.bold.copyWith(fontSize: 22.sp)),
            CommonText(title: "Track expenses together, stay in sync",style: TextStyles.regular.copyWith(fontSize: 12.sp,color: AppColors.black838383)),
            ...
            Column(
              ...
              children: [
                Container(
                  width: 40,
                  decoration: BoxDecoration(
                    color: AppColors.clr261861
                  ),
                  child: CommonText(title: 'You',style: TextStyles.regular.copyWith(fontSize: 12.sp),textAlign: TextAlign.center,),
                ),
            ...
            Column(
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                      color: AppColors.couple1
                  ),
                  child: CommonText(title: 'Partner',style: TextStyles.regular.copyWith(fontSize: 12.sp),textAlign: TextAlign.center,),
                ),
                CommonInputFormField(
                    textEditingController: loginWatch.usernameController
                ),
